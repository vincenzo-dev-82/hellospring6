package com.vincenzo.hellospring.learningtest;
...
public class ClockTest {
    ...
    @DisplayName("Clock을 이용해서 LocalDateTime.now?")
    @Test
    void clock() {
    ...
    @DisplayName("Clock을 테스트에서 사용할 때 내가 원하는 시간을 지정해서 현재 시간을 가져오게 할 수 있는가?")
    @Test
    void fixedClock() {
